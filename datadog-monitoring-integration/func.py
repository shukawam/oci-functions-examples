...
all_tag_keys = 'resourceId, resourceName, deploymentId, deploymentName, route, httpMethodType, httpStatusCode, httpStatusCategory, backendType, backendName, backendHttpStatusCode, backendHttpStatusCategory, responseCacheResult, entitlementName, subscriberId, subscriberName, clientName, action, usagePlanId, usagePlanName, apdexLevel, apmrumType, apmrumPageUpdateType, browserName, deviceType, osFamily, type, webApplicationName, customMarker, errorCategory, genre, host, isApmAgentMonitored, isHarAvailable, isLogAvailable, isNetworkDataAvailable, isRetryExecution, isScreenshotAvailable, maintenanceWindowActive, monitorId, monitorName, monitorType, requestType, target, userAgent, vantagePoint, vantagePointDisplayName, appserver, appserverDisplayPort, appserverDomainName, appserverId, appserverName, appserverPorts, appserverServerName, appserverType, appserverVersion, apmVersion, displayName, serviceInstanceId, serviceName, oraPackagedApp, createdBy, hostAddress, hostAddresses, hostname, hostnameCanonical, hostnames, processId, vmName, vmVendor, vmVersion, workingDirectory, kubernetesNamespace, kubernetesNodeName, kubernetesPodAnnotations, kubernetesPodLabels, kubernetesPodName, ociAvailabilityDomain, ociCompartmentId, ociComputeShape, ociDisplayName, ociFaultDomain, ociInstanceId, ociRegion, okeClusterId, okeClusterLabel, okeCompartmentName, okeKubernetesVersion, okeNodePoolId, okeNodepoolLabel, okeTenancyId, ebsAkRegionAppId, ebsAkRegionCode, ebsClassName, ebsFunctionId, ebsOaFunc, ebsOahp, ebsOapb, ebsOasf, ebsRegionAppId, ebsRegionClass, ebsRegionCode, ebsRespAppId, ebsRespId, osAvailableProcessors, osName, osVersion, siebelResourceType, siebelResourceName, siebelResourceOperation, processName, telemetryAutoVersion, telemetrySdkLanguage, telemetrySdkName, telemetrySdkVersion, probe, dataType, performanceFactorName, performanceFactorType, cause, dBUniqueName, osUserName, sessionType, attachmentId, availabilityDomain, faultDomain, imageId, instancePoolId, region, resourceDisplayName, shape, component, timestamp, version, faultClass, maintenanceDueTime, computeMaintenanceAction, recommendedAction, metadataVersion, path, status, connectorId, connectorName, partitionId, sourceName, taskName, targetName, errorCode, errorType, responseCode, responseGroup, clusterId, nodepoolId, nodeState, nodeCondition, jobName, applicationId, applicationName, executorId, workspaceId, compartmentId, taskId, taskType, taskStatus, statusCode, result, statusFamily, instanceId, hostName, deploymentType, diskgroupName, filesystemName, instanceNumber, instanceName, tablespaceName, tablespaceType, managedDatabaseId, managedDatabaseGroupId, jobId, ioType, memoryType, memoryPool, collectionName, errorSeverity, parseType, transactionStatus, schemaName, waitClass, projectId, projectName, buildPipelineId, stageId, lifecycleState, stageType, repositoryType, repositoryId, repositoryName, pushType, pullType, deployPipelineId, deployStageId, deployStageName, resourceDomain, eventType, actionType, mountTargetId, throughput, size, operation, resourceType, healthItem, mtResourceName, obcResourceName, userTenancyId, responseType, errorMessage, extractName, replicatName, distributionPathName, receiverPathName, protocol, resourceid, integrationFlowIdentifier, adapterIdentifier, inboundProcessingEndpointInformation, inboundProcessingResponseStatus, outboundInvocationEndpointInformation, outboundInvocationResponseStatus, accountSubscription, flowCode, flowVersion, meterType, fleetName, javaVendor, javaMajorVersion, javaVersion, backendSetName, lbComponent, lbHostId, listenerName, logObjectId, logObjectName, logGroupId, logGroupName, logSourceService, resourcename, srcType, agentHostName, dbSystemId, heatWaveNode, parentResourceId, publicIp, dropType, tableName, endpointType, topicDisplayName, resultCodeisVisible, resultMessage, subscriptionId, telemetrySourceType, telemetrySourceIdentifier, telemetrySourceEntityIdentifier, associatedOciResourceId, sourceMetricName, dataProcessingFrequencyInHrs, resourceMetric, forecastModel, exceededForecastWindow, aggregateDataMeasure, isDegraded, isVariant, isInefficient, isPlanChanged, isIncreasingIo, isIncreasingCpu, isIncreasingWait, sourceIdentifier, sourceEntityIdentifier, associatedResourceId, queueName, isVisible, tier, meshId, meshComponent, riskLevel, primaryDomain, module, countryCode, responseCodeGroup, '
