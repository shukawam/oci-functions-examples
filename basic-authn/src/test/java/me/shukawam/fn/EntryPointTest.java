...
//     @Test
//     public void shouldReturnInvalidResponseWithNoSQL() throws JsonProcessingException {
...
//         testing.thenRun(EntryPoint.class, "handleRequest");
//         FnResult result = testing.getOnlyResult();
//         assertEquals(mapper.writeValueAsString(new AuthNResponse(false, "Basic realm=\"Username or Password is invalid.\"")), result.getBodyAsString());
//     }
